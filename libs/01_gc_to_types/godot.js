...
let godot = {}
godot.class_name = _name => `class_name ${to_pascal_case(_name)}\n`;
godot.class_name.with_parent = parent => _name => `${godot.class_name(_name).slice(0,-1)} extends ${to_pascal_case(parent)}\n`;
