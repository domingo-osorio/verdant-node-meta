...
const snake_case = string => splitCaps(string).replace(/\W+/g, " ").split(/ |\B(?=[A-Z])/).map(word => word.toLowerCase()).join('_');
// End of reference
...
export {snake_case, capitalize, to_camel_case, to_pascal_case, to_upper_snake};
